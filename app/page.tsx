  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      iconsRef.current.forEach((icon) => {
        ...
        // Glow proximity — icons near mouse light up blue
        ...
        // Draw glow layer if close to mouse
...
Generated by Design Bestie — designbesti.com`;
            ...
            <button
              onClick={() => {
                ...
                const lines = [
                  ...
                  "",
                  divider,
                  "Powered by Design Bestie — designbesti.com",
                  divider,
                ];
